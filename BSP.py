...
class BSP:
    ...
    def __init__(self, filepath):
        ...
        self.disp_info = []  # type: List[DispInfo]
        self.disp_verts = []  # type: List[DispVert]
    ...
    def read_all(self):
        ...
        self.read_array(self.header.lumps[LUMP_ENUM.LUMP_DISPINFO], DispInfo, self.disp_info)
        self.read_array(self.header.lumps[LUMP_ENUM.LUMP_DISP_VERTS], DispVert, self.disp_verts)
